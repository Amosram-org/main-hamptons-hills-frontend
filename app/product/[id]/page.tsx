...
import { getProductById, getFeaturedProducts } from '@/data/product'
...
export default async function ProductPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const whatsappUrl = `https://wa.me/+254721462076?text=${encodedMessage}`
        ...
        <div className="bg-gray-50">
            ...
            <div className="container mx-auto px-4 py-12">
                ...
                <div className="space-y-6">
                    ...
                    <Link href='/#customized-service' className="flex-1 rounded-full border border-gray-300 bg-white px-6 py-3 text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
