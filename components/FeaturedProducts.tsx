  ...
  return (
    <section className='min-h-screen w-full px-4 lg:px-16' id='featured-products'> 
      <div className='max-w-7xl mx-auto'>
        <h2 className='text-3xl lg:text-4xl text-black/80 font-semibold text-center mb-8'>Our Valuable Services</h2>
        ...
        <div className='py-13'>
            <div className='grid grid-cols-1  md:grid-cols-2 lg:grid-cols-3 gap-6'>
              <div className='flex flex-col gap-3 bg-gray-100 border-4 border-main-amber/10 rounded-2xl p-4 py-8 items-center '>
                  ...
                  <h1 className='text-xl lg:text-xl font-medium text-black/90 mb-2'>HEADSTONE CRAFTING AND DESIGNS</h1>
                  <p className='text-black/70 text-sm text-center'>  We craft and design headstones with precision and care, combining skilled workmanship with thoughtful design. Every piece is tailored to reflect the life, values, and memory of the individual being honored. From selecting quality stone to engraving details and finishes, our team ensures each headstone is both durable and deeply meaningful.</p>
              </div>
              ...
              <div className='flex flex-col gap-3 bg-gray-100 border-4 border-main-amber/10 rounded-2xl p-4 py-8 items-center'>
                  ...
                  <p className='text-black/70 text-sm text-center'>We provide professional inscription services, carefully engraving names, dates, and personalized messages that honor loved ones. Using durable techniques and precise craftsmanship, we ensure each inscription is clear, lasting, and a true reflection of the memory it carries.</p>
              </div>
        ...
        <h2 className='text-3xl lg:text-4xl text-black/80 font-semibold text-center mb-16'>Featured Products</h2>
